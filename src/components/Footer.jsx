        ...
        <div className="text-center mb-8">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-md mx-auto leading-relaxed">
              궁금한 점이 있으시다면<br />
              <span className="font-medium text-gray-800 dark:text-gray-200">언제든 연락해 주세요!</span>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-6 my-8">
            {/* 전화번호 */}
            <button 
              className="flex items-center text-gray-600 dark:text-slate-300 hover:text-green-500 dark:hover:text-green-400 transition-colors group cursor-pointer"
            >
