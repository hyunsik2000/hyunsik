...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-300 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center space-x-8 mb-8">
            ...
            <a 
              ...
              className="flex items-center text-gray-600 dark:text-slate-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors group"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-200 dark:border-slate-700 pt-8 text-center">
          <p className="text-gray-500 dark:text-slate-400 text-sm">
            © 2025 Portfolio. Made with ❤️ React & Tailwind CSS
          </p>
        </div>
